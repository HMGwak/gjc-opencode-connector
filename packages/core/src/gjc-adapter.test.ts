...
const session = { id: "local", ownerId: "owner-1", adapter: "gjc", remoteId: "s1", status: "active" as const, reconciliationEpoch: 0, reconciled: false, remoteRevision: null, controlMode: "controlled" as const, origin: "coordinator-start" as const, transcriptStatus: "available" as const, activeProjectorVersion: "1", title: null, workdir: null, sourceCreatedAt: null, archivedAt: null, createdAt: "", updatedAt: "" };
