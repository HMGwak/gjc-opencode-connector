...
const session = { id: "local", ownerId: "owner-1", adapter: "opencode", remoteId: "remote", status: "active" as const, reconciliationEpoch: 0, reconciled: false, remoteRevision: null, controlMode: "view-only" as const, origin: "opencode-discovery" as const, transcriptStatus: "available" as const, activeProjectorVersion: "1", title: null, workdir: null, sourceCreatedAt: null, archivedAt: null, createdAt: "", updatedAt: "" };
